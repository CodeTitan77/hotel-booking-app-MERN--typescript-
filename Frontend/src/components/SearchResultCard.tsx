...
const SearchResultCard = ({hotel}:Props) => {
  return (
    <div className="grid grid-cols-1 xl:grid-cols-[2fr__3fr] border border-slate-300 rounded-lg p-8 gap-8">
      ...
      <div className="grid grid-rows-[1fr_2fr_1fr] ">
       ...
       className="text-2xl font-bold cursor-pointer">{hotel.name}</Link>
      ...
      <div className="grid grid-cols-2 items-end whitespace-nowrap">
        <div className="flex gap-1 items-center">
          {hotel.facilities.slice(0,3).map((facility)=>(
            <span className="bg-slate-500 p-2 rounded-lg font-bold text-xs whitespace-nowrap">{facility}</span>
